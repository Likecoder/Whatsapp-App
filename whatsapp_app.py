...
st.write(":red[Open Sidebar To Upload File.]")
...
if condition:
    ...
    # select box
    # may be no group notification
    if "Group_Notification" in a:
...
l = f'<a target="_blank" href="google.com">Hyperlink in Streamlit dataframe</a>'
# st.write(l.to_html(escape=False, index=False), unsafe_allow_html=True)
